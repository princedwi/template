...
export const getProject = (id:number) => api.get(`http://localhost:1337/api/project-infos/${id}`);
export const conceptReview = (formData: Concept_Review) => api.post("http://localhost:1337/api/concept-reviews", {data:formData});
// export const getconceptReview = (id:number) => api.post("http://localhost:1337/api/concept-reviews", {data:formData});
